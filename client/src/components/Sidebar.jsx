...
const Sidebar = ({ isOpen, setIsOpen, collapsed, setCollapsed }) => {
  ...
  const menuItems = [
    ...
    { title: "Search", path: "/search", icon: <IoMdSearch className='h-5 w-5' /> },
    {
      title: "Leads",
      icon: <UserPlus className='h-5 w-5' />,
      dropdown: true,
      items: [
        { title: "Add Single Leads", path: "/leads", icon: <Contact className='h-4 w-4' /> },
        { title: "Add Bulk Leads", path: "/leads/add", icon: <Upload className='h-4 w-4' /> },
      ],
    },
    {
      title: "Campaigns",
      ...
      dropdown: true,
      items: [
        { title: "Create Campaign", path: "/campaign/createCampaign", icon: <PlusSquare className='h-4 w-4' /> },
        { title: "All Campaigns", path: "/campaign/allCampaigns", icon: <FolderOpenDot className='h-4 w-4' /> },
      ],
    },
  ];
    ...
    <>
      ...
      >
        ...
        <div className='flex items-center justify-between px-4 py-3 border-b relative'>
          {!collapsed && (
            <img src='/newlogo.png' alt='Logo' className='h-[110px] object-contain' />
          )}
          <button
