  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-2xl font-semibold mb-4">Uploaded Lead Sheets</h2>
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto rounded-xl shadow">
            <table className="min-w-full text-sm border bg-white">
              <thead className="bg-gray-100">
                <tr>
                  <th className="p-3 text-left">Uploaded File Name</th>
              ...
              <tbody>
                {importedLeads.map((sheet, i) => (
                  <tr key={i} className="odd:bg-white even:bg-gray-50">
                    <td className="p-3">{sheet.sheetName}</td>
          ...
          <p className="text-gray-600">No leads uploaded yet.</p>
        )}
      </div>
    </div>
  );
